...
<style type="text/css">
	.bg-login{
		...
		background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)) ,url(<?php echo base_url("assets/bg.png");?>);
	}
...
<body class="bg-login">
		<header class="bg-login">
			<div class="navbar">
				...
				<div class="contents">
					<h1>Laundry</h1>
					<p>Jl. BrigJend H. Hasan Basry, RT.03, LK.01, No.38, Kandangan</p>
				</div>
			</div>
			<div class="button">
